...
Mario::Mario() :
	...
	growth_timer(0),
	invincible_timer(0),
	big_walk_animation(CELL_SIZE, "C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/BigMarioWalk.png", MARIO_WALK_ANIMATION_SPEED),
	walk_animation(CELL_SIZE, "C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/MarioWalk.png", MARIO_WALK_ANIMATION_SPEED)
{
	start_time = clock();
	texture.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/MarioIdle.png");
	font.loadFromFile("C:\\Users\\vladk\\Desktop\\PakenhamBlItalic.ttf");
	coinsTextView.setString("COINS: " + std::to_string(coins));
	coinsTextView.setFont(font);
	coinsTextView.setCharacterSize(50);
	coinsTextView.setFillColor(sf::Color::White);
	coinsTextView.setPosition(0, 0);
...
int Mario::get_time_life() {
	last_time = (dead == 0) ? (clock() - start_time) / 1000 : last_time;
	return last_time;
}

void Mario::start_timer() {
	start_time = clock();
}


void Mario::save_time_as_file()
{
	int last_best;
	std::ifstream fin("records.txt");
	if (!fin.is_open()) { std::cout << "Error open txt file for save data."; return; }
	fin >> last_best;
	fin.close();
	if (last_time < last_best || last_best == -1) {
...
void Mario::die(const bool i_instant_death)
{
	...
	if (1 == i_instant_death)
	{
		...
		if (0 == powerup_state)
		{
			texture.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/MarioDeath.png");
		}
		else
		{
			texture.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/BigMarioDeath.png");
		}
	}
		...
		if (0 == dead)
		{
			if (0 < powerup_state)
			{
				if (1 == crouching)
				{
					...
					{
						texture.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/BigMarioCrouch.png");
					}
				}
				else if (0 == on_ground)
				{
					...
					if (0 == draw_big)
					{
						...
						texture.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/MarioJump.png");
					}
					else
					{
						texture.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/BigMarioJump.png");
					}
				}
				else
				{
					if (0 == horizontal_speed)
					{
						...
						{
							texture.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/BigMarioIdle.png");
						}
					}
...

					{
						if (0 == draw_big)
						{
							...
							texture.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/MarioBrake.png");
						}
						else
						{
							texture.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/BigMarioBrake.png");
						}
					}
					else
					{
