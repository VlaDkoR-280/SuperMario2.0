...
MapManager::MapManager() :
	coin_animation(CELL_SIZE, "C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/Coin.png", COIN_ANIMATION_SPEED),
	question_block_animation(CELL_SIZE, "C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/QuestionBlock.png", QUESTION_BLOCK_ANIMATION_SPEED)
{
	map_texture.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/Map.png");
...
void MapManager::draw_map(const bool i_draw_background, const bool i_underground, const unsigned i_view_x, sf::RenderWindow& i_window)
{
	...
	for (unsigned short a = map_start; a < map_end; a++)
	{
		for (unsigned short b = 0; b < map_height; b++)
		{
			...
			{
				sf::Color pixel = map_sketch.getPixel(a, b + 2 * map_height - 1);
				...
				if (255 == pixel.a)
				{
					if (0 < a)
					{
						pixel_left = map_sketch.getPixel(a - 1, b + 2 * map_height - 1);
					}
					...
					{
						pixel_right = map_sketch.getPixel(1 + a, b + 2 * map_height - 1);
					}

					if (b < map_height - 1)
					{
						pixel_down = map_sketch.getPixel(a, 1 + b + 2 * map_height - 1);
					}
...
{
	map_sketch.loadFromFile("C:/Users/vladk/source/repos/Super-Mario-Bros/Source/Resources/Images/LevelSketch" + std::to_string(static_cast<unsigned short>(i_current_level)) + ".png");
}
